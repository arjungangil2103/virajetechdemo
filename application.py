...
<body id="sample">
  <div class="textColumn">
    <h1>Congratulations - VIRAJETECH LIVE</h1>
    <p>Your first VIRAJETECH - AWS Elastic Beanstalk Python Application is now running on your own dedicated environment in the AWS Cloud</p>
  </div>
